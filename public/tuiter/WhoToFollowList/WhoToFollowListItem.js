    ...
    return(`
        <li class="list-group-item">
          <div class="row align-items-center">
            <img class="col-3 rounded-circle" src="${who.avatarIcon}">
            <div class="col-6" style="margin-left: -1px;">
              <div class="row overflow-hidden">
                <b class="col-auto p-0 overflow-hidden" style="max-width: 80%">${who.userName}</b>
                <div class="col-1 p-0">
            ...
            <button class="col-auto ms-auto btn btn-primary rounded-pill" style="background-color:#00aced">
              Follow
            </button>
          </div>
        </li>
